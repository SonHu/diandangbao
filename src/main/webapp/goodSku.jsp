                            ...
                            <div class="col-xs-12">
                                <div class="table-responsive">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                        ...
                                        <c:forEach var="goodSkus" items="${goodSkusList}">
                                            <tr>
                                                <td class="center">1</td>
                                                <td class="left"><a href="http://localhost:8081/cust/goods/list#" onclick="window.location.href='/cust/goods/add?good_id=14886110'">${goodSkus.skuName}</a></td>
                                                <td class="center">${goodSkus.skuCost}</td>
                                                <td class="center">${goodSkus.skuPrice}</td>
                                                <td class="center">${goodSkus.skuPmoney}</td>
                                                <td class="center">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="sender" id="sample-table-2_info">
                                                共 23 条记录，每页 7 条，共 4 页
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="dataTables_paginate paging_bootstrap sender">
                                                <ul class="pagination">
                                                    <li><a href="goodsku.do?page=1" class="active">1</a></li>
                                                    <li><a href="goodsku.do?page=2">2</a></li>
                                                    <li><a href="goodsku.do?page=3">3</a></li>
                                                    <li><a href="goodsku.do?page=4">4</a></li>
                                                </ul>
